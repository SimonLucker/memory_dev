...
import { markLoaded, markReady } from '../core/ready.js'
...
export default function App() {
  ...
  // through data/api.js: Supabase (deployed) or the vite dev endpoints (local).
  ...
  useEffect(() => { markLoaded(); markReady() }, []) // tools/shot.mjs waits for window.__ready
